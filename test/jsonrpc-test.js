...
console.log('Starting JSON-RPC test...');
...
setTimeout(async () => {
  try {
    ...
    // Step 2: Test ping method
    console.log("Step 2: Testing ping method...");
    await sendRpcRequest({
      jsonrpc: "2.0",
      id: "ping-1",
      method: "ping"
    ...
    // Step 3: Test chat method
    console.log("Step 3: Testing chat method...");
    await sendRpcRequest({
      jsonrpc: "2.0",
      id: "chat-1",
      method: "chat",
